...
let NowPlaying = () => {
  ...
  function MovieCard(props) {
    ...
    return (
      <div className="relative">
       ...
       <img src="https://i.imgur.com/Z2MYNbj.png/large_movie_poster.png" alt={title} className=" w-full"   />) :
  ...
  let fetchNowPlaying = async () => {
    let { data } = await axios({
      method: "get",
      url:
        "https://api.themoviedb.org/3/movie/now_playing?api_key=12b71e90fbfaf4c9bd6b49822f24b090&language=en-US&page=" +
        currentPage,
    });
